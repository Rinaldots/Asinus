...
def generate_launch_description():
    ...
    topic_name_arg = DeclareLaunchArgument(
        'topic_name', default_value=TextSubstitution(text='diff_base_controller/cmd_vel'))
    linear_speed_arg = DeclareLaunchArgument(
        'linear_speed', default_value=TextSubstitution(text='0.5'))
    angular_speed_arg = DeclareLaunchArgument(
        'angular_speed', default_value=TextSubstitution(text='0.5'))
